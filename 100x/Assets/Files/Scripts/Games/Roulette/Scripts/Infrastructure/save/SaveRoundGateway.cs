...
namespace Infrastructure
{
    ...
    {
        private static protected readonly string FILE_NAME = "100xRoulete";
        ...
        IEnumerator SavePlayer(IObserver<Unit> observer, Round roundData)
        {
            ...
            // PlayerPrefs.SetInt("Coins", roundData.playerMoney);
        ...
        IEnumerator LoadPlayer(IObserver<Unit> observer) 
        {
            ...
            // roundData.playerMoney = PlayerPrefs.GetInt("Coins", 1000);
